        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4 p-5">
                    <form role="form text-left" action="{{ route('admin.data-guru.store') }}" method="POST"
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control  @error('institution') is-invalid @enderror"
                                ...
                                id="institution" value="{{ old('institution') }}">
                            @error('institution')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control  @error('study_program') is-invalid @enderror"
                                ...
                                name="study_program" id="study_program" value="{{ old('study_program') }}">
                            @error('study_program')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control  @error('graduation_year') is-invalid @enderror"
                                ...
                                name="graduation_year" id="graduation_year" value="{{ old('graduation_year') }}">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control  @error('subjects') is-invalid @enderror"
                                ...
                                name="subjects" id="subjects" value="{{ old('subjects') }}">
                            @error('subjects')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control  @error('teaching_class') is-invalid @enderror"
                                ...
                                name="teaching_class" id="teaching_class" value="{{ old('teaching_class') }}">
